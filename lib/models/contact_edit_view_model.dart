...
class ContactEditViewModel with ChangeNotifier {
  ...
  ContactEditViewModel(this.selectedContact) {
  ...
  Future createNewContact(BuildContext context, String name, String speciality,
  ...
  Future changeContactInfo(BuildContext context, String name, String speciality,
      String email, String phone, List<SocialInputModel> socials) async {
    loadingStatus = LoadingStatus.searching;
    notifyListeners();
    ...
    // if (speciality.isNotEmpty && post != selectedContact.speciality) {
