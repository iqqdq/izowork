...
class AnalyticsObjectsFilterScreenBodyWidget extends StatefulWidget {
  final VoidCallback onTypeTap;
  final VoidCallback onApplyTap;
  final VoidCallback onResetTap;

  const AnalyticsObjectsFilterScreenBodyWidget(
      {Key? key,
  ...
  @override
  _AnalyticsObjectsFilterScreenBodyState createState() =>
      _AnalyticsObjectsFilterScreenBodyState();
}

class _AnalyticsObjectsFilterScreenBodyState
    extends State<AnalyticsObjectsFilterScreenBodyWidget> {
  late AnalyticsObjectsFilterViewModel _analyticsObjectsFilterViewModel;

  final options = ['По возрастанию', 'По убыванию'];
  List<int> tags = [];

  final options2 = ['По возрастанию', 'По убыванию'];
  List<int> tags2 = [];
  ...
  Widget build(BuildContext context) {
    _analyticsObjectsFilterViewModel =
        Provider.of<AnalyticsObjectsFilterViewModel>(context, listen: true);
                ...
                children: [
                  ...
                  ListView(
                      ...
                      children: [
                        ...
                        /// EFFECTIVENESS SORTING GRID VIEW
                        ChipsChoice<String>.multiple(
                            padding:
                                const EdgeInsets.symmetric(horizontal: 16.0),
                            wrapped: true,
