...
class CompleteDealScreenBodyWidget extends StatefulWidget {
  final Function(String, List<PlatformFile>) onTap;

  const CompleteDealScreenBodyWidget({Key? key, required this.onTap})
      : super(key: key);

  @override
  _CompleteDealScreenBodyState createState() => _CompleteDealScreenBodyState();
}

class _CompleteDealScreenBodyState extends State<CompleteDealScreenBodyWidget> {
