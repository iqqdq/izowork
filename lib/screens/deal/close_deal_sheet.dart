...
class CloseDealSheetWidget extends StatefulWidget {
  final Function(String, List<PlatformFile>) onTap;

  const CloseDealSheetWidget({Key? key, required this.onTap}) : super(key: key);

  @override
  _CloseDealSheetState createState() => _CloseDealSheetState();
}

class _CloseDealSheetState extends State<CloseDealSheetWidget> {
