...
class CompleteDealSheetWidget extends StatefulWidget {
  final Function(String, List<PlatformFile>) onTap;

  const CompleteDealSheetWidget({Key? key, required this.onTap})
      : super(key: key);

  @override
  _CompleteDealSheetState createState() => _CompleteDealSheetState();
}
