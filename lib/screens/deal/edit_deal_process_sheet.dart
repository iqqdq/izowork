...
class EditDealProcessSheetWidget extends StatefulWidget {
  final Function(String, List<PlatformFile>) onTap;

  const EditDealProcessSheetWidget({Key? key, required this.onTap})
      : super(key: key);

  @override
  _EditDealProcessSheetState createState() => _EditDealProcessSheetState();
}

class _EditDealProcessSheetState extends State<EditDealProcessSheetWidget> {
