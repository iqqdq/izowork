...
class ChatFilterSearchBodyScreenWidget extends StatefulWidget {
  final VoidCallback onPop;

  const ChatFilterSearchBodyScreenWidget({Key? key, required this.onPop})
      : super(key: key);

  @override
  _ChatFilterSearchBodyScreenState createState() =>
      _ChatFilterSearchBodyScreenState();
}

class _ChatFilterSearchBodyScreenState
    extends State<ChatFilterSearchBodyScreenWidget> {
                  ...
                  children: [
                    Padding(
                        ...
                        child: Stack(children: [
                          ...
                          const Center(
                              child: TitleWidget(text: Titles.employee))
                        ])),
              ...
              !_show
                  ? Column(
                      ...
                      children: [
                          Row(children: [
                            Expanded(
                                child: Text(Titles.enterFilialName,
