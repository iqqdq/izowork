...
class CompaniesFilterSearchBodyScreenWidget extends StatefulWidget {
  final VoidCallback onPop;

  const CompaniesFilterSearchBodyScreenWidget({Key? key, required this.onPop})
      : super(key: key);

  @override
  _CompaniesFilterSearchBodyScreenState createState() =>
      _CompaniesFilterSearchBodyScreenState();
}

class _CompaniesFilterSearchBodyScreenState
              ...
              ListView(
                  ...
                  children: [
                    ...
                    InputWidget(
                        ...
                        onTap: () => setState,
                        onChange: (text) =>
                            // TODO SEARCH COMPANY MANAGERS
                            setState(() => _show = text.isEmpty ? false : true),
                        onClearTap: () =>
                            // TODO CLEAR COMPANY MANAGERS SEARCH
              ...
              !_show
                  ? Column(
                      ...
                      children: [
                          Row(children: [
                            Expanded(
                                child: Text(Titles.enterManagerName,
