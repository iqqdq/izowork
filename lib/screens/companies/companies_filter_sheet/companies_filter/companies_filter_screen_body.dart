...
class CompaniesFilterScreenBodyWidget extends StatefulWidget {
  final VoidCallback onManagerTap;
  final VoidCallback onApplyTap;
  final VoidCallback onResetTap;

  const CompaniesFilterScreenBodyWidget(
      {Key? key,
  ...
  @override
  _CompaniesFilterScreenBodyState createState() =>
      _CompaniesFilterScreenBodyState();
}

class _CompaniesFilterScreenBodyState
    extends State<CompaniesFilterScreenBodyWidget> {
  late CompaniesFilterViewModel _companiesFilterViewModel;

  final options = ['По возрастанию', 'По убыванию'];
  List<int> tags = [];

  final options2 = ['Поставщик', 'Покупатель', 'Проектировщик'];
  List<int> tags2 = [];
  ...
  Widget build(BuildContext context) {
    _companiesFilterViewModel =
        Provider.of<CompaniesFilterViewModel>(context, listen: true);
