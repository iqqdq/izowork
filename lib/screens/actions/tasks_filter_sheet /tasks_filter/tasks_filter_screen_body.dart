...
class TasksFilterScreenBodyWidget extends StatefulWidget {
  final VoidCallback onResponsibleTap;
  final VoidCallback onApplyTap;
  final VoidCallback onResetTap;

  const TasksFilterScreenBodyWidget(
      {Key? key,
  ...
  @override
  _TaskFilterScreenBodyState createState() => _TaskFilterScreenBodyState();
}

class _TaskFilterScreenBodyState extends State<TasksFilterScreenBodyWidget> {
  late TasksFilterViewModel _tasksFilterViewModel;

  final options = ['Завершенные', 'В работе', 'Отложены', 'Просрочены'];
  List<int> tags = [];
