...
class DocumentsFilterWidget extends StatefulWidget {
  final VoidCallback onApplyTap;
  final VoidCallback onResetTap;

  const DocumentsFilterWidget(
      {Key? key, required this.onApplyTap, required this.onResetTap})
      : super(key: key);

  @override
  _DocumentsFilterState createState() => _DocumentsFilterState();
}

class _DocumentsFilterState extends State<DocumentsFilterWidget> {
