...
import 'package:izowork/features/contacts/view/contacts_filter_sheet/contacts_filter_page_view_screen_body.dart';
...
class ContactsViewModel with ChangeNotifier {
  ...
  ContactsViewModel() {
    getContactList(pagination: Pagination(), search: '');
  }
  ...
  Future getContactList({
    ...
    await sl<ContactRepositoryInterface>()
        .getContacts(
  ...
  void resetFilter() => _contactsFilter = null;
