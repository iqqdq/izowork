...
import 'package:izowork/features/dialog/view_model/dialog_view_model.dart';
...
import 'package:izowork/features/dialog/view/views/bubble_widget.dart';
import 'package:izowork/api/api.dart';
import 'package:izowork/features/dialog/view/views/dialog_add_task_widget.dart';
import 'package:izowork/features/participants/view/participants_screen.dart';
...
class _DialogScreenBodyState extends State<DialogScreenBodyWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => _updateDialog());
  }
  ...
  bool _isSamePrevDate(int index) {
    DateTime date = _dialogViewModel.messages[index].createdAt;
    DateTime? dateTime = index == _dialogViewModel.messages.length - 1
        ? null
        : _dialogViewModel.messages[index + 1].createdAt;
